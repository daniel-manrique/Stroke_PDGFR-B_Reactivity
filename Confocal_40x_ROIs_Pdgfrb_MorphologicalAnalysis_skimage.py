# -*- coding: utf-8 -*-
"""
Created on Sat Jul 15 17:22:00 2023

@author: Daniel Manrique-Castano, P.hD.
@orcid: 0000-0002-1912-1764
@affiliation: Univerisity Laval (Laboratory of neurovascular interactions) 

license: "CC BY"

This pyton-based sript perform the morphological analysis of cells.
"""
...
dir_path = "F:/Daniel\Project_PDGFRB_Stroke/2.Images/Exp2-CD31,CD13/40x_ROIS_Confocal/Images_Cells/"
save_dir = "F:/Daniel/Project_PDGFRB_Stroke/2.Images\Exp2-CD31,CD13/40x_ROIS_Confocal/Images_Morphology/Pdgfr/"
...
all_results.to_csv(os.path.join(save_dir, 'Pdgfr_Morphology.csv'), index=False)
all_branch_data.to_csv(os.path.join(save_dir, 'Pdgfr_Skeleton.csv'), index=False)
