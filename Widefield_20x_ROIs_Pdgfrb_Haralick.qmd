...
Next, we perform principal component analysis (PCA) as a dimensionality reduction method to for multiple variables. We will use the `factoMineR`[@FactoMineR] and `factoextra` [@factoextra] packages to have access to the PCA and visualization functions.
