...
Pdgfrb_L1MCAO_Fit1 <- 
  brm(
    ...
    seed    = 8807,
    control = list(adapt_delta = 0.99, max_treedepth = 15),
    file    = "Models/Pdgfrb-CD31_Coloc/Pdgfrb_L1MCAO_Fit1.rds",
    file_refit = "never") 
...
ggsave(
  ...
  filename = "Plots/Widefiled_10x_Pdgfrb-CD31_Coloc/Pdgfrb_L1MCAO_fig.png", 
  width    = 10, 
  height   = 9, 
  units    = "cm")
...
ggsave(
  ...
  filename = "Plots/Widefiled_10x_Pdgfrb-CD31_Coloc/Pdgfrb_Region_Contrast_Fig.png", 
  width    = 9, 
  height   = 9, 
  units    = "cm")
...
```{r}
#| label: Pdgfrb_Striatum_Exploratory
#| include: true
#| warning: false
#| message: false
...
Pdgfrb_Striatum_Fit1 <- 
  brm(
    ...
    seed    = 8807,
    control = list(adapt_delta = 0.99, max_treedepth = 15),
    file    = "Models/Pdgfrb-CD31_Coloc/Pdgfrb_Striatum_Fit1.rds",
    file_refit = "never") 
...
Pdgfrb_Striatum_Fit2 <- 
  brm(
    ...
    seed    = 8807,
    control = list(adapt_delta = 0.99, max_treedepth = 15),
    file    = "Models/Pdgfrb-CD31_Coloc/Pdgfrb_Striatum_Fit2.rds",
    file_refit = "never") 
...
ggsave(
  ...
  filename = "Plots/Widefiled_10x_Pdgfrb-CD31_Coloc/Pdgfrb_Striatum_fig1.png", 
  width    = 10, 
  height   = 9, 
  units    = "cm")
...
ggsave(
  ...
  filename = "Plots/Widefiled_10x_Pdgfrb-CD31_Coloc/Pdgfrb_Striatum_Sigma_fig1.png", 
  width    = 10, 
  height   = 9, 
  units    = "cm")
...
ggsave(
  ...
  filename = "Plots/Widefiled_10x_Pdgfrb-CD31_Coloc/Pdgfrb_Striatum_fig2.png", 
  width    = 10, 
  height   = 9, 
  units    = "cm")
