...
**Working dataset**: The `Data_Processed/Widefield_5x_Ipsilateral_TdTom-Gfap_Inten.csv`data frame containing the area of the ipsilateral hemisphere in mm2 (`Tissue_Area`). The measurement was performed using a FIJI [@schindelin2012] [script](https://osf.io/gbvsc).
...
Ipsi_Summary <- read.csv(file = "Data_Processed/Widefield_5x_Ipsilateral_TdTom-Gfap_Inten.csv", header = TRUE)
...
Shrinkage_Fit1 <- 
  brm(
    ...
    file    = "Models/Widefield_5x_Ipsilateral_TdTom_Shrinkage/Widefield_5x_Ipsilateral_TdTom_Shrinkage_Fit1.rds",
    file_refit = "never") 
...
Shrinkage_Fit2 <-
    ...
    seed    = 8807,
    control = list(adapt_delta = 0.99, max_treedepth = 15),
    file    = "Models/Widefield_5x_Ipsilateral_TdTom_Shrinkage/Widefield_5x_Ipsilateral_TdTom_Shrinkage_Fit2.rds",
    file_refit = "never")
...
Shrinkage_Fit3 <- 
  ...
  seed = 8807,
  control = list(adapt_delta = 0.99, max_treedepth = 15),
  file    = "Models/Widefield_5x_Ipsilateral_TdTom_Shrinkage/Widefield_5x_Ipsilateral_TdTom_Shrinkage_Fit3.rds",
  file_refit = "never")
...
Shrinkage_Line_fig <- 
  ...
  filename = "Plots/Widefield_5x_Ipsilateral_TdTom_Shrinkage/Widefield_5x_Ipsilateral_TdTom_Shrinkage_Line.png", 
  width    = 9, 
  height   = 9, 
  units    = "cm")
...
ggsave(plot     = Shrinkage_Sigma_fig, 
       filename = "Plots/Widefield_5x_Ipsilateral_TdTom_Shrinkage/Widefield_5x_Ipsilateral_TdTom_Shrinkage_Sigma.png", 
       width    = 9, 
       height   = 9, 
       units    = "cm")
...
We plot the posterior summary using the `describe_posterior` function from `bayestestR` package [@bayestestR; @makowski2019] and save .html and .tex tables using the `modelsummary`package [@modelsummary-2; @modelsummary].
...
modelsummary(Shrinkage_Fit3, 
             ...
             output = "Tables/html/Widefield_5x_Ipsilateral_TdTom_Shrinkage_Fit3_Table.html",
             )
...
modelsummary(Shrinkage_Fit3, 
             ...
             statistic = "conf.int",
             gof_omit = 'ELPD|ELDP s.e|LOOIC|LOOIC s.e|WAIC|RMSE',
             output = "Tables/tex/Widefield_5x_Ipsilateral_TdTom_Shrinkage_Fit3_Table.tex",
             )
```
...
Here we see the different "fragments" from the curve with predicted point estimates and their uncertainty. We summarize further using the `estimate_smooth`function. Here, we use the `gtsummary` package [@gtsummary-2; @gtsummary-2] to save the results tables as .html and .tex files. 
...
gt::gtsave(filename = "Tables/html/Widefield_5x_Ipsilateral_TdTom_Shrinkage_Fit3_Deriv.html")

gt::gt(round(Shrinkage_Derivative, digits = 2)) %>%
gt::gtsave(filename = "Tables/tex/Widefield_5x_Ipsilateral_TdTom_Shrinkage_Fit3_Deriv.tex")
```
...
ggsave(
  ...
  filename = "Plots/Widefield_5x_Ipsilateral_TdTom_Shrinkage/Widefield_5x_Ipsilateral_TdTom_Shrinkage_Fit3_Deriv.png", 
  width    = 9, 
  height   = 9, 
  units    = "cm")
