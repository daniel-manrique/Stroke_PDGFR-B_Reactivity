...
basePath <- "QuPath_Ipsilateral_5x"
resultsPath <- "Data_Raw/CellCoordinates/Widefield_5x_Ipsilateral_Gfap-Pdgfrb-Dapi_CellCoordinates"
...
coordinatesPath <- "Data_Raw/CellCoordinates/Widefield_5x_Ipsilateral_Gfap-Pdgfrb-Dapi_CellCoordinates/"
...
Ipsilateral_Intensity_5x <- read.csv(file = 'Data_Raw/Raw_Widefield_5x_Ipsilateral_Gfap-Pdgfrb_Inten.csv', header = TRUE)
...
# Read the data table
Ipsilateral_AreaIntensity_Summary_Raw <- read.csv(file = 'Data_Raw/Raw_Widefield_5x_Ipsilateral_Gfap-Pdgfrb_AreaIntensity.csv', header = TRUE)
...
write.csv(Ipsilateral_Summary_5x, "Data_Processed/Widefield_5x_Ipsilateral_Gfap-Pdgfrb_Inten.csv", row.names = FALSE)
```
...
saveRDS(Result_Hyperframe, "PointPatterns/Widefield_5x_Ipsilateral_Gfap-Pdgfrb_Striatum_PointPatterns.rds")
```
...
# Read the data tables
Ipsilateral_Striatum_Intensity_5x <- read.csv(file = 'Data_Raw/Raw_Widefield_5x_Ipsilateral_Gfap-Pdgfrb_Striatum_Inten.csv', header = TRUE)
...
Gfap_Annotations_Raw <- 
  read.csv(file = 'Data_Raw/Raw_Widefield_5x_Ipsilateral_Gfap_Str_QuPathAnnotations.csv', 
           header = TRUE
           )
Gfap_Annotations_Raw <- Gfap_Annotations_Raw[, -1]

Pdgfrb_Annotations_Raw <- 
  read.csv(file = 'Data_Raw/Raw_Widefield_5x_Ipsilateral_Pdgfrb_Str_QuPathAnnotations.csv', 
           header = TRUE
           )
...
write.csv(Ipsilateral_Striatum_Summary_5x, "Data_Processed/Widefield_5x_Ipsilateral_Gfap-Pdgfrb_Str_Inten.csv", row.names = FALSE)
```
