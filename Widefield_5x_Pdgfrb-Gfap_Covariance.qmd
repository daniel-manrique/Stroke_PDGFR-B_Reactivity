...
png("Plots/Pdgfr_Rhohat_3D_High.png", width = 600, height = 400)
par(mar=c(7,9,2,2))
...
png("Plots/Pdgfr_Rhohat_7D_High.png", width = 600, height = 400)
par(mar=c(7,10,2,2))
...
png("Plots/Pdgfr_Rhohat_14D_High.png", width = 600, height = 400)
par(mar=c(7,10,2,2))
...
png("Plots/Pdgfr_Rhohat_30D_High.png", width = 600, height = 400)
par(mar=c(7,10,2,2))
...
png("Plots/Pdgfr_Rhohat_7D_Low.png", width = 600, height = 400)
par(mar=c(7,10,2,2))
...
png("Plots/Pdgfr_Rhohat_14D_Low.png", width = 600, height = 400)
par(mar=c(7,10,2,2))
...
png("Plots/Pdgfr_Rhohat_30D_Low.png", width = 600, height = 400)
par(mar=c(7,10,2,2))
...
# Point Process model for PDGFR-β^high^ - GFAP covariance
