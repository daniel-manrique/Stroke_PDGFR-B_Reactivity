...
PointPatterns <- readRDS("PointPatterns/Widefield_5x_Ipsilateral_Pdgfrb-Gfap_PPP.rds")
...
title(xlab = "GFAP (intensity)", 
      mgp = c(4.5, 2, 0), 
      cex.lab = 3)   
title(ylab = expression("(p)Pdgfrb-β"^high), 
      mgp = c(4.5, 1, 0), 
      cex.lab = 3) 
...
title(xlab = "GFAP (intensity)", 
      mgp = c(4.5, 1, 0), 
      cex.lab = 3)   
title(ylab = expression("(p)Pdgfrb-β"^Low), 
      mgp = c(5, 1, 0),
      cex.lab = 3) 
