...
**Parent dataset:** KLF4, PDGFR-β and CD31 stained ischemic hemispheres imaged at 10x (with stitching). Samples were taken 14 days post-ischemia (DPI). The raw images and pre-processing scripts (if applicable) are available at the Zenodo repository (10.5281/zenodo.10553084) under the name `Widefield_10x_Ipsilateral_KO_Klf4-Pdgfrb-CD31.zip`.
